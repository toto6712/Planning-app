  ...
  return (
    <Card className="bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200">
      ...
      <CardContent className="space-y-6">
        ...
        {/* Informations sur l'IA avec performance OSRM */}
        <div className="bg-white/60 backdrop-blur-sm rounded-lg p-4 border border-purple-200">
          <h4 className="font-medium text-purple-900 mb-3 flex items-center gap-2">
            ...
            <Badge variant="outline" className="text-green-700 border-green-300 ml-2">
              OSRM Local
            </Badge>
          </h4>
          <div className="grid grid-cols-2 gap-2 text-xs text-purple-800">
            <div className="flex items-center gap-1">
              ...
              <span>Calculs ultra-rapides (localhost)</span>
            </div>
            <div className="flex items-center gap-1">
            ...
            <div className="flex items-center gap-1">
              <div className="w-2 h-2 bg-green-400 rounded-full"></div>
              <span>20 requêtes parallèles</span>
            </div>
            <div className="flex items-center gap-1">
              <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
          ...
          <div className="mt-3 bg-green-50 rounded-md p-2 border border-green-200">
            <div className="text-xs text-green-800 flex items-center justify-between">
              <span>Performance attendue:</span>
              <span className="font-mono">~40 trajets/seconde</span>
            </div>
          </div>
        </div>
